...
def get_args():
    ...
    parser.add_argument("--option", type=str,
                        help='frozen: the BERT parameters are frozen; flexible: BERT parameters are updated',
                        choices=('frozen', 'flexible'), default="frozen")
    ...
    parser.add_argument("--lr", type=float, help="learning rate, default lr for 'frozen': 1e-3, 'flexible': 1e-5",
                        default=1e-5)
